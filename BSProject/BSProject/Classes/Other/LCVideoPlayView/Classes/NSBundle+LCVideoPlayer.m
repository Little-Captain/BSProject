...
@implementation NSBundle (LCVideoPlayer)
...
+ (instancetype)videoPlayerFramework {
    ...
    if (videoPlayerFramework == nil) {
        ...
        videoPlayerFramework = [NSBundle bundleForClass:NSClassFromString(@"LCVideoPlayView")];
    }
...
+ (instancetype)videoPlayerResourceBundle {
    ...
    if (videoPlayerResourceBundle == nil) {
        videoPlayerResourceBundle = [NSBundle bundleWithPath:[[self videoPlayerFramework] pathForResource:@"LCVideoPlayView" ofType:@"bundle"]];
    }
